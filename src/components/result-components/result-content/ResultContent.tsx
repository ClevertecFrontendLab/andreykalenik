...
export const ResultContent: React.FC<ResultContentProps> = ({
    ...
    const styledefaultDestop: React.CSSProperties = {
        width: 539,
        borderRadius: 2,
        paddingBlock: 64,
        paddingInline: 85.5,
    ...
    const styledefaultMobile: React.CSSProperties = {
        width: 328,
        borderRadius: 2,
        paddingBlock: 32,
        paddingInline: 16,
    ...
    const styleSlimDestop: React.CSSProperties = {
        width: 539,
        borderRadius: 2,
    ...
    const styleSlimMobile: React.CSSProperties = {
        width: 328,
        borderRadius: 2,
        paddingBlockStart: 64,
        paddingBlockEnd: 56,
