        ...
        <Content className={styles.wrapper}>
            <div className={styles.firstReview}>
                <Card style={{paddingBottom:56}}>
                    <Title level={3} style={{color: '#061178', fontWeight: 500, fontSize: 24, textAlign: 'center', marginBlock: 48}}>
                        Оставьте свой отзыв первым
                    </Title>
                    <Paragraph style={{color:'#8C8C8C', fontSize: 14, lineHeight:1.3, maxWidth:521, marginInline: 'auto', textAlign: 'center', marginBottom:0}}>
                ...
                <Button
                    type='primary'
                    style={sm ? 
                        {width: 142, marginBlock: 20, marginInline: 'calc(50% - calc(142px / 2))', fontSize: 14}:
